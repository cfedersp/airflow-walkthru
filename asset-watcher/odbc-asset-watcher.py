...
class ODBCTableTrigger(BaseEventTrigger):
    ...
    def serialize(self) -> tuple[str, dict[str, Any]]:
        ...
        return ("odbc-asset-watcher.ODBCTableTrigger", triggerParams );
